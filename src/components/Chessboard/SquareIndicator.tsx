...
const SquareIndicator = styled.div`
    position: absolute;
    width: ${(props: SquareIndicatorProps) => `calc(12.5% + ${(props.type === "selection" ? -4 : 1)}px)`};
    height: ${(props: SquareIndicatorProps) => `calc(12.5% + ${(props.type === "selection" ? -4 : 1)}px)`};
    ...
    border: ${(props: SquareIndicatorProps) => props.type === "selection" ? '3px solid #fcdb03' : 'none'};
